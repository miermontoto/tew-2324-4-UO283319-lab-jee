...
public class BGError implements Serializable {
	...
	public BGError() {
		...
		this.view = new String(bundle.getString("unknownError"));
		this.method = new String(bundle.getString("unknownError"));
		this.clase = new String(bundle.getString("unknownError"));
		this.message = new String(bundle.getString("unknownError"));
	}
